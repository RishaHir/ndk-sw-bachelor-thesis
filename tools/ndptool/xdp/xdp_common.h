...
/*
 * XDP common header
 * Structures and address allocation
 *  mechanism of AF_XDP apps 
 * 
...
// Holds all infromation about xsocket
struct xsk_info {
...
// Holds all information about UMEM
struct umem_info {
...
// Data structure for compatibility with the ndp-tool design
